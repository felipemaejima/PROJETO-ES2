  ...
  <div class="box">
    <div class="box-content">
      <div class="box-infos box-installments">
        <?php echo form_open('installment', array('id' => 'invoiceinstallment-edit')); ?>
        <div class="align-items">
          <div class="tab-column-title">
            ...
            <div class="functions-tab tab-row">
              <button type="submit" class="btn-purple" id="submit-invoiceinstallment-edit">salvar</button>
              <button type="button" onclick="window.history.back();" class="btn-gray">voltar</button>
              <a href="<?php echo base_url('invoicepayment?referer=' . $this->uri->segment(2)); ?>"
              class="btn-green">Criar Pagamento</a>
            </div>
          </div>
        </div>
        <div class="column-33 c-large c-medium c-small">
          <div class="form-input-content">
            ...
            <a href="<?php echo base_url('invoice/' . $installment[0]->link); ?>">
              fatura
        ...
        <div class="column">
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_input('text', 'customername', 'customer', FALSE, $installment[0]->customername, TRUE); ?>
            <?php echo get_input('hidden', 'customerid', 'customer id', FALSE, $installment[0]->customerid, TRUE); ?>
            <?php echo get_input('text', 'total', 'total', FALSE, $installment[0]->total); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
          ...
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_input('text', 'deadline', 'data de vencimento', FALSE, $installment[0]->deadline != 0 ? date('d/m/Y', $installment[0]->deadline) : FALSE); ?>
            <?php echo get_input('text', 'percentage', 'percentual', FALSE, $installment[0]->percentage); ?>
          </div>
        </div>
        ...
        <div class="column">
          <div class="column-33 c-large c-medium c-small">
            ...
            <?php echo get_checkbox('billingdoccreated', 'boleto gerado', FALSE, $installment[0]->billingdoccreated); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_input('text', 'billingdocid', 'id boleto', FALSE, $installment[0]->billingdocid, TRUE); ?>
            <?php echo get_checkbox('billingdocsended', 'boleto enviado', FALSE, $installment[0]->billingdocsended); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
        ...
        <div class="tab-wrapper">
          <div id="payments" class="tab-wrapper-content" style="display: flex"><div class="overflow">
            <div class="table">
              <div class="table-head" style="min-width: 700px; max-width: 100%;">
              ...
              <?php foreach($payments as $payment): ?>
                <div class="table-content <?php echo $count % 2 == 0 ? 'table-content-color' : ''; ?>"
                  ...
                  <div class="column" style="min-width: 100px; padding-right: 1rem;" title="subsidiaria">
                  ...
                  <input type="hidden" name="paymentvalue[]" value="<?php echo $payment->total; ?>">
                  <div class="column align-right" style="min-width: 100px;" title="remover">
                    <a href="<?php echo base_url('invoicepayment/' . $payment->id . '?edit=T'); ?>" target="_blank" class="btn-blue">
                      editar
                    </a>
                    <a href="" class="btn-red btn-remove-payment">remover</a>
                  </div>
                </div>
                <?php $count++; ?>
              <?php endforeach; ?>
