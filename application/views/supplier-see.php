    ...
    <div class="box-content">
      <div class="box-infos box-suppliers">
        ...
        <div class="functions-tab tab-row">
          <a href="<?php echo base_url('supplier/' . $this->uri->segment(2) . '?edit=T'); ?>"
        ...
        <div class="column">
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_select($isperson, 'isperson', 'tipo', FALSE, $supplier[0]->isperson, TRUE); ?>
            <?php echo get_input('text', 'document', 'cnpj', FALSE, $supplier[0]->document, TRUE); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_input('text', 'name', 'nome', FALSE, $supplier[0]->name, TRUE); ?>
            <?php echo get_input('text', 'legalname', 'razão social', FALSE, $supplier[0]->legalname, TRUE); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_textarea('comments', 6, 'anotações', $supplier[0]->comments, TRUE); ?>
          </div>
        </div>
        <div class="group-title">informações fiscais</div>
        <div class="column">
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_input('text', 'im', 'inscrição municipal', FALSE, $supplier[0]->im, TRUE); ?>
            <?php echo get_input('text', 'ie', 'inscrição estadual', FALSE, $supplier[0]->ie, TRUE); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_input('text', 'cnae', 'cnae', FALSE, $supplier[0]->cnae, TRUE); ?>
            <?php echo get_input('text', 'cnaedescription', 'descrição do cnae', FALSE, $supplier[0]->cnaedescription, TRUE); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_select($activitysectors, 'activitysector', 'setor de atividade', FALSE, $supplier[0]->activitysector, TRUE); ?>
            <?php echo get_select($freighttypes, 'freighttype', 'tipo de frete', FALSE, $supplier[0]->freighttype, TRUE); ?>
            <?php echo get_input('text', 'carrier', 'transportadora padrão', FALSE, $supplier[0]->carriername, TRUE); ?>
            <?php echo get_input('hidden', 'carrierid', 'carrier id', FALSE, $supplier[0]->carrierid, TRUE); ?>
          </div>
        </div>
        <div class="group-title">classificação</div>
        <div class="column">
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_checkbox('ieexempt', 'IE isento', TRUE, $supplier[0]->ieexempt); ?>
            <?php echo get_checkbox('ieimmune', 'IE imune', TRUE, $supplier[0]->ieimmune); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_checkbox('icmstaxpayer', 'contribuinte de ICMS', TRUE, $supplier[0]->icmstaxpayer); ?>
            <?php echo get_checkbox('simplesnacional', 'simples nacional', TRUE, $supplier[0]->simplesnacional); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_checkbox('mei', 'empreendedor individual', TRUE, $supplier[0]->mei); ?>
            <?php echo get_checkbox('publicentityexempticms', 'orgão público isento de ICMS', TRUE, $supplier[0]->publicentityexempticms); ?>
          </div>
        </div>
        <div class="group-title">informações secundárias</div>
        <div class="column">
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_input('text', 'phone', 'telefone', FALSE, $supplier[0]->phone, TRUE); ?>
            <?php echo get_input('text', 'email', 'email', FALSE, $supplier[0]->email, TRUE); ?>
            <?php echo get_input('text', 'url', 'site', FALSE, $supplier[0]->url, TRUE); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_input('text', 'founded', 'fundação', FALSE, $supplier[0]->founded ? date('d/m/Y', $supplier[0]->founded) : FALSE, TRUE); ?>
            <?php echo get_input('text', 'entitystatusdate', 'data do status da empresa', FALSE, $supplier[0]->entitystatusdate ? date('d/m/Y', $supplier[0]->entitystatusdate) : FALSE, TRUE); ?>
            <?php echo get_input('text', 'entitystatus', 'status da empresa', FALSE, $supplier[0]->entitystatus, TRUE); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
        ...
        <div class="tab-wrapper">
          ...
          <div id="licensecontrol" class="tab-wrapper-content" style="display: none">
            <div class="column">
              <div class="column-33 c-large c-medium c-small">
                <?php echo get_input('text', 'federalpolicelicense', 'licença de polícia federal', FALSE, $supplier[0]->federalpolicelicense, TRUE); ?>
                <?php echo get_input('text', 'datefederalpolicelicense', 'data expiração da licença da política federal', FALSE, $supplier[0]->datefederalpolicelicense ? date('d/m/Y', $supplier[0]->datefederalpolicelicense) : FALSE, TRUE); ?>
              </div>
              <div class="column-33 c-large c-medium c-small">
                <?php echo get_input('text', 'civilpolicelicense', 'licença de polícia civil', FALSE, $supplier[0]->civilpolicelicense, TRUE); ?>
                <?php echo get_input('text', 'datecivilpolicelicense', 'data expiração da licença da política civil', FALSE, $supplier[0]->datecivilpolicelicense ? date('d/m/Y', $supplier[0]->datecivilpolicelicense) : FALSE, TRUE); ?>
              </div>
              <div class="column-33 c-large c-medium c-small">
                <?php echo get_input('text', 'armylicense', 'licença do exército', FALSE, $supplier[0]->armylicense, TRUE); ?>
                <?php echo get_input('text', 'datearmylicense', 'data expiração da licença do exército', FALSE, $supplier[0]->datearmylicense ? date('d/m/Y', $supplier[0]->datearmylicense) : FALSE, TRUE); ?>
              </div>
            </div>
            <div class="overflow">
              <div class="table">
          ...
          <div id="systeminformation" class="tab-wrapper-content" style="display: none">
            <div class="column">
              ...
              <div class="column-33 c-large c-medium c-small">
                <?php echo get_checkbox('iscustomer', 'cliente', TRUE, $supplier[0]->iscustomer); ?>
                <?php echo get_checkbox('issupplier', 'fornecedor', TRUE, $supplier[0]->issupplier); ?>
                <?php echo get_checkbox('iscarrier', 'transportadora', TRUE, $supplier[0]->iscarrier); ?>
              </div>
              <div class="column-33">
              </div>
            </div>
