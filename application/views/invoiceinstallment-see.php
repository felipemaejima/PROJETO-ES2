  ...
  <div class="box">
    <div class="box-content">
      <div class="box-infos box-installments">
        <?php echo form_open('installment', array('id' => 'installment-edit')); ?>
        <div class="align-items">
          <div class="tab-column-title">
            ...
            <div class="functions-tab tab-row">
              <a href="<?php echo base_url('invoiceinstallment/' . $this->uri->segment(2) . '?edit=T'); ?>"
        ...
        <div class="column">
          <div class="column-33 c-large c-medium c-small">
            ...
            <?php echo get_checkbox('billingdocsended', 'boleto enviado', TRUE, $installment[0]->billingdocsended); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_input('text', 'billingdocid', 'id boleto', FALSE, $installment[0]->billingdocid, TRUE); ?>
            <?php echo get_checkbox('billingdoccreated', 'boleto gerado', TRUE, $installment[0]->billingdoccreated); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
