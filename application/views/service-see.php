    ...
    <div class="box-content">
      <div class="box-infos box-services">
        ...
        <div class="functions-tab tab-row">
          <a href="<?php echo base_url('service/' . $this->uri->segment(2) . '?edit=T'); ?>"
          class="btn-purple">editar</a>
          <button type="button" onclick="window.history.back();" class="btn-gray">voltar</button>
          <?php if ($permission) : ?>
            <a href="<?php echo base_url('service/create-invoice?referer=' . $this->uri->segment(2)); ?>"
            class="btn-gray">faturar</a>
          <?php endif; ?>  
        </div>
        <div class="column-33 c-large c-medium c-small">
          ...
          <?php echo get_input('hidden', 'createdfrom', 'criado de', FALSE, $service[0]->id); ?>
        </div>
        ...
        <div class="column">
          ...
          <div class="column-33 c-large c-medium c-small">
            ...
            <?php echo get_input('hidden', 'salesmanid', 'id vendedor', FALSE, $service[0]->salesmanid); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_textarea('comments', 6, 'anotações', $service[0]->comments, TRUE); ?>
          </div>
        </div>
        <div class="group-title">informações adicionais</div>
        <div class="column">
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_input('text', 'servicedate', 'data do atendimento', FALSE,  date('d/m/Y', $service[0]->servicedate), TRUE); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
            <?php //  echo get_select($servicestatus, 'status', 'status', FALSE, $service[0]->status, TRUE); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
          </div>
        </div>
        ...
        <div class="column">
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_input('text', 'volumesquantity', 'volumes', FALSE, $service[0]->volumesquantity, TRUE); ?>
            <?php echo get_input('text', 'grossweight', 'peso bruto kg', FALSE, $service[0]->grossweight, TRUE); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_input('text', 'netweight', 'peso liquido kg', FALSE, $service[0]->netweight, TRUE); ?>
            <?php echo get_input('text', 'volumetype', 'tipo de volume', FALSE, $service[0]->volumetype, TRUE); ?>
          </div>
          <div class="column-33">
          </div>
        </div>
        ...
        <div class="column">
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_select($freighttypes, 'freighttype', 'tipo de frete', FALSE, $service[0]->freighttypeid, TRUE); ?>
            <?php echo get_input('text', 'carrier', 'nome da transportadora', FALSE, $service[0]->carriername, TRUE); ?>
            <?php echo get_input('hidden', 'carriername', 'transportadora', FALSE, $service[0]->carriername); ?>
        ...
        <div class="tab-wrapper">
          <div id="items" class="tab-wrapper-content" style="display: flex">
            ...
            <div class="overflow">
              <div class="table">
                <div class="table-head" style="min-width: 1125px; max-width: 100%;">
                ...
                <?php foreach ($items as $key => $item): ?>
                  <div
                    ...
                    style="min-width: 1225px; max-width: 100%; <?php echo $item->isinactive == 'T' ? 'display: none;' : ''; ?>">
                    ...
                    <div class="column" style="min-width: 125px; padding-right: 1rem;" title="atendido">
                      <div class="form-input-box">
                        <input type="text" name="itemquantityserved[]" placeholder="quantidade atendida" value="<?php echo $item->served; ?>" disabled>
