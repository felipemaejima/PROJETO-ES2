    ...
    <div class="box-content">
      <div class="box-infos">
        ...
        <div class="functions-tab">
          <a class="btn-purple"
            href="<?php echo base_url('returnreceipt/' . $this->uri->segment(2) . '?edit=T'); ?>">editar</a>
          <button type="button" onclick="window.history.back();" class="btn-gray">voltar</button>
          <a class="btn-gray"
            href="<?php echo base_url('creditmemo?referer=' . $this->uri->segment(2)); ?>" target="_blank">gerar memorando de crédito</a>
        </div>
        ...
        <div class="column">
          ...
          <div class="column-33">
            <?php echo get_textarea('comments', 6, 'anotações', $returnreceipt[0]->comments, TRUE); ?>
          </div>
        </div>
        <div class="group-title">classificação</div>
        <div class="column">
          <div class="column-33">
            <?php echo get_input('text', 'fiscaldocnumber', 'nota fiscal', FALSE, $returnreceipt[0]->fiscaldocnumber, TRUE); ?>
          </div>
          <div class="column-33">
            <?php echo get_input('text', 'fiscaldocnumberdate', 'data da nota fiscal', FALSE, date('d/m/Y', $returnreceipt[0]->fiscaldocnumberdate), TRUE); ?>
          </div>
          <div class="column-33">
          </div>
        </div>
                ...
                <?php foreach ($items as $key => $item): ?>
                  <div
                    ...
                    <div class="column" style="min-width: 125px; padding-right: 1rem;" title="faturado">
                      <?php echo $receiveditems[$key]->totalreceived; ?>
                      <input type="hidden" name="itemquantitybilled[]"
                        value="<?php echo $receiveditems[$key]->totalreceived; ?>">
                    </div>
                    ...
                    <div class="column" style="min-width: 125px; padding-right: 1rem;" title="recebido">
                      <div class="form-input-box">
                        <input type="text" name="itemreceived[]" placeholder="quantidade recebida"
                          value="<?php echo $item->linereceived; ?>" disabled>
                      </div>
                    </div>
