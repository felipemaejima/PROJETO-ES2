      ...
      <div class="box-infos box-creditmemos">
        ...
        <div class="align-items">
          <div class="tab-column-title">
            ...
            <div class="functions-tab tab-row">
              <button type="submit" class="btn-purple" id="submit-creditmemo-edit">salvar</button>
        ...
        <div class="column">
          <div class="column-33 c-large c-medium c-small">
            ...
            <?php echo get_input('text', 'customerpurchaseorder', 'pedido de compra do cliente', FALSE, $creditmemo[0]->customerpurchaseorder); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
          ...
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_textarea('comments', 6, 'anotações', $creditmemo[0]->comments); ?>
          </div>
        </div>
        ...
        <div class="column">
          ...
          <div class="column-33 c-large c-medium c-small">
            <br>
            <?php echo get_checkbox('excludecommission', 'excluir comissão', FALSE, $creditmemo[0]->excludecommission == 'T' ? TRUE : FALSE); ?>
          </div>
        </div>
        <div class="group-title">envio</div>
        <div class="column">
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_input('text', 'volumetype', 'tipo de volume', FALSE, $creditmemo[0]->volumetype); ?>
            <?php echo get_input('text', 'volumesquantity', 'volumes', FALSE, $creditmemo[0]->volumesquantity); ?>

          </div>
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_input('text', 'netweight', 'peso liquido kg', FALSE, $creditmemo[0]->netweight); ?>
            <?php echo get_input('text', 'grossweight', 'peso bruto kg', FALSE, $creditmemo[0]->grossweight); ?>
          </div>
          <div class="column-33">
        ...
        <div class="column">
          ...
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_input('text', 'freight', 'frete', '<i class="ph ph-arrows-clockwise calculate-freight"></i>', $creditmemo[0]->freight); ?>
            <?php echo get_input('text', 'discount', 'desconto', '<i class="ph ph-arrows-clockwise calculate-discount"></i>', $creditmemo[0]->discount); ?>
          </div>
          <div class="column-33">
          </div>
        </div>
        ...
        <div class="tab-wrapper">
          <div id="nfe" class="tab-wrapper-content" style="display: flex">
            ...
            <!-- adicionar campos carta de correção e aliquota -->
             <div class="column">
              <div class="column-33 c-large c-medium c-small">
                <?php echo get_select($operationtypes, 'operationtype', 'tipo de operação', FALSE, $creditmemo[0]->operationtypeid); ?>
              </div>
              <div class="column-33 c-large c-medium c-small">
                <!-- este campo deve ser obrigatório após gerar NF -->
                <?php echo get_input('text', 'trafficguide', 'guia de tráfego', FALSE, $creditmemo[0]->trafficguide); ?>
              </div>
              <div class="column-33 c-large c-medium c-small">
                <?php echo get_textarea('additionalinformation', 6, 'informações adicionais da nota', $creditmemo[0]->additionalinformation); ?>
              </div>
            </div>
            <div class="group-title">informações NF-e</div>
            <div class="column">
              <div class="column-33 c-large c-medium c-small">
                <?php echo get_input('text', 'fiscaldocnumber', 'número da NF-e', FALSE, $creditmemo[0]->fiscaldocnumber ); ?>
                <?php echo get_input('text', 'fiscaldocdate', 'data de autorizacão', FALSE, $creditmemo[0]->fiscaldocdate ? date('d/m/Y H:i:s', $creditmemo[0]->fiscaldocdate) : ''); ?>
                <?php echo get_input('text', 'fiscaldocsenddate', 'data de envio', FALSE, $creditmemo[0]->fiscaldocsenddate ? date('d/m/Y H:i:s', $creditmemo[0]->fiscaldocsenddate) : ''); ?>
              </div>
              <div class="column-33 c-large c-medium c-small">
                <?php echo get_input('text', 'fiscaldocaccesskey', 'chave de acesso', FALSE, $creditmemo[0]->fiscaldocaccesskey); ?>
                <?php echo get_input('text', 'fiscaldocstatus', 'status da NF-e', FALSE, $creditmemo[0]->fiscaldocstatus); ?>
                <?php echo get_input('text', 'fiscaldocrefaccesskey', 'chave da NF-e referente', FALSE, $creditmemo[0]->fiscaldocrefaccesskey); ?>
              </div>
              <div class="column-33">
                <?php echo get_input('text', 'fiscaldoccancellationdate', 'data de cancelamento', FALSE, $creditmemo[0]->fiscaldoccancellationdate ? date('d/m/Y H:i:s', $creditmemo[0]->fiscaldoccancellationdate) : ''); ?>
                <?php echo get_input('text', 'fiscaldocreturnmessage', 'mensagem de retorno', FALSE, $creditmemo[0]->fiscaldocreturnmessage); ?>
              </div>
            </div>
          </div>
