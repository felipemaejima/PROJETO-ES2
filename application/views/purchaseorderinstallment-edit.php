      ...
      <div class="box-infos box-installments">
        ...
        <div class="align-items">
          <div class="tab-column-title">
            ...
            <div class="functions-tab tab-row">
              <button type="submit" class="btn-purple" id="submit-purchaseorderinstallment-edit">salvar</button>
              <button type="button" onclick="window.history.back();" class="btn-gray">voltar</button>
              <a href="<?php echo base_url('purchaseorderpayment?referer=' . $this->uri->segment(2)); ?>"
        ...
        <div class="column">
          <div class="column-33 c-large c-medium c-small">
            ...
            <?php echo get_checkbox('billingdoccreated', 'boleto gerado', FALSE, $installment[0]->billingdoccreated == 'T' ? TRUE : FALSE); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_input('text', 'billingdocid', 'id boleto', FALSE, $installment[0]->billingdocid, TRUE); ?>
            <?php echo get_checkbox('billingdocsended', 'boleto enviado', FALSE, $installment[0]->billingdocsended == 'T' ? TRUE : FALSE); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
              ...
              <?php foreach($payments as $payment): ?>
                <div class="table-content <?php echo $count % 2 == 0 ? 'table-content-color' : ''; ?>"
                  ...
                  <div class="column align-right" style="min-width: 100px;" title="remover">
                    <a href="<?php echo base_url('purchaseorderpayment/' . $payment->id . '?edit=T'); ?>" target="_blank" class="btn-blue">
                      editar
                    </a>
