    ...
    <div class="box-content">
      <div class="box-infos box-separations">
        ...
        <div class="functions-tab tab-row">
          <button type="submit" class="btn-purple" id="submit-separation-edit">salvar</button>
        ...
        <div class="column">
          ...
          <div class="column-33">
            <?php echo get_textarea('comments', 6, 'anotações', $separation[0]->comments); ?>
          </div>
        </div>
        <div class="tab-container">
          <label class="tab-btn active" data-toggle="items">itens</label> |
          <label class="tab-btn" data-toggle="requisicoes">requisições</label> |
                  ...
                  <div
                    ...
                    <div class="column" style="min-width: 125px; padding-right: 1rem;" title="separado">
                      <div class="form-input-box">
                        ...
                        <?php echo $item->status == 'em compra' ? 'disabled' : ''; ?>>
                        <input type="hidden" name="possibleitemquantitycommitted[]"
                        value="<?php echo $item->itemquantitycommitted; ?>">
                      </div>
                    </div>
