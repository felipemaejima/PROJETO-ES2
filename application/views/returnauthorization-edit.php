    ...
    <div class="box-content">
      <div class="box-infos box-returnauthorization">
        ...
        <div class="functions-tab tab-row">
          <button type="submit" class="btn-purple" id="submit-returnauthorization-edit">salvar</button>
        ...
        <div class="column">
          ...
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_textarea('comments', 6, 'anotações', $returnauthorization[0]->comments); ?>
          </div>
        </div>
                ...
                <?php foreach ($items as $key => $item): ?>
                  <div
                    ...
                    <div class="column" style="min-width: 150px; padding-right: 1rem;" title="total devolvido">
                      ...
                      <input type="hidden" name="totalreturned[]"
                        value="<?php echo $returneditems[$key]->totalreturned; ?>">
                    </div>
                    <div class="column" style="min-width: 150px; padding-right: 1rem;" title="devolvido">
                      <div class="form-input-box">
                        <input type="text" name="itemreturned[]" placeholder="quantidade devolvida"
                          value="<?php echo $item->itemreturned; ?>" data-initqty="<?php echo $item->itemreturned; ?>">
                      </div>
                    </div>
                  </div>
                  <?php $count++; ?>
