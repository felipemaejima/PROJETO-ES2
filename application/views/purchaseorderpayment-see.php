  ...
  <div class="box">
    <div class="box-content">
      <div class="box-infos box-payments">
        <?php echo form_open('payment', array('id' => 'purchaseorderpayment-edit')); ?>
        ...
        <div class="align-items">
          <div class="tab-column-title">
            ...
            <div class="functions-tab tab-row">
              <a href="<?php echo base_url('purchaseorderpayment/' . $this->uri->segment(2) . '?edit=T'); ?>"
        ...
        <div class="column">
          ...
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_textarea('comments', 6, 'anotações', $payment[0]->comments, TRUE); ?>
          </div>
        </div>
