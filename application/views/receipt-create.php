  ...
  <div class="box">
    <div class="box-content">
      <div class="box-infos">
        ...
        <?php echo form_open('receipt', array('id' => 'receipt-create')); ?>
        ...
        <div class="column">
          <div class="column-33">
            <?php echo get_input('text', 'supplier', 'fornecedor', FALSE, $purchaseorder[0]->suppliername, TRUE); ?>
          ...
          <div class="column-33">
            ...
            <div class="form-input-content">
              ...
              <a href="<?php echo base_url('purchaseorder/' . $purchaseorder[0]->id); ?>">pedido de compra <?php echo $purchaseorder[0]->tranid; ?></a>
              <div class="error-createdfrom error-input"></div>
            </div>
            <?php echo get_input('hidden', 'createdfrom', 'criado de', FALSE, $purchaseorder[0]->id); ?>
          </div>
          <div class="column-33">
