    ...
    <div class="box-content">
      <div class="box-infos">
        ...
        <div class="functions-tab">
          <a href="<?php echo base_url('receipt/' . $this->uri->segment(2) . '?edit=T'); ?>"
        ...
        <div class="column">
          <div class="column-33">
            <?php echo get_input('text', 'fiscaldocnumber', 'nota fiscal', FALSE, $receipt[0]->fiscaldocnumber, TRUE); ?>
          </div>
          <div class="column-33">
            <?php echo get_input('text', 'fiscaldocnumberdate', 'data da nota fiscal', FALSE, ($receipt[0]->fiscaldocnumberdate ? date('d/m/Y', $receipt[0]->fiscaldocnumberdate) : FALSE), TRUE); ?>
          </div>
          <div class="column-33">
          </div>
        </div>
