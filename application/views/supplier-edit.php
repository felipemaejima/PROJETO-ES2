  ...
  <div class="box">
    <div class="box-content">
      <div class="box-infos box-suppliers">
        ...
        <?php echo form_open('supplier/' . $this->uri->segment(2), array('id' => 'supplier-edit')); ?>
        <div class="functions-tab tab-row">
          <button type="submit" class="btn-purple" id="submit-supplier-edit">salvar</button>
        ...
        <div class="column">
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_select($isperson, 'isperson', 'tipo', FALSE, $supplier[0]->isperson); ?>
            <?php echo get_input('text', 'document', 'cnpj', FALSE, $supplier[0]->document); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_input('text', 'name', 'nome', FALSE, $supplier[0]->name); ?>
            <?php echo get_input('text', 'legalname', 'razão social', FALSE, $supplier[0]->legalname); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_textarea('comments', 6, 'anotações', $supplier[0]->comments); ?>
          </div>
        </div>
        <div class="group-title">informações fiscais</div>
        <div class="column">
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_input('text', 'im', 'inscrição municipal', FALSE, $supplier[0]->im); ?>
            <?php echo get_input('text', 'ie', 'inscrição estadual', FALSE, $supplier[0]->ie, $customer[0]->isperson == 'b48e880d-c9a6-df7e-d749-54b30c93c12f' ? TRUE : FALSE ); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_input('text', 'cnae', 'cnae', FALSE, $supplier[0]->cnae); ?>
            <?php echo get_input('text', 'cnaedescription', 'descrição do cnae', FALSE, $supplier[0]->cnaedescription); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_select($activitysectors, 'activitysector', 'setor de atividade', FALSE, $supplier[0]->activitysector); ?>
            <?php echo get_select($freighttypes, 'freighttype', 'tipo de frete', FALSE, $supplier[0]->freighttype); ?>
            <?php echo get_input('text', 'carrier', 'transportadora padrão', FALSE, $supplier[0]->carriername); ?>
            <?php echo get_input('hidden', 'carrierid', 'carrier id', FALSE, $supplier[0]->carrierid); ?>
          </div>
        </div>
        <div class="group-title">classificação</div>
        <div class="column">
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_checkbox('ieexempt', 'IE isento', FALSE, $supplier[0]->ieexempt); ?>
            <?php echo get_checkbox('ieimmune', 'IE imune', FALSE, $supplier[0]->ieimmune); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_checkbox('icmstaxpayer', 'contribuinte de ICMS', FALSE, $supplier[0]->icmstaxpayer); ?>
            <?php echo get_checkbox('simplesnacional', 'simples nacional', FALSE, $supplier[0]->simplesnacional); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_checkbox('mei', 'empreendedor individual', FALSE, $supplier[0]->mei); ?>
            <?php echo get_checkbox('publicentityexempticms', 'orgão público isento de ICMS', FALSE, $supplier[0]->publicentityexempticms); ?>
          </div>
        </div>
        <div class="group-title">informações secundárias</div>
        <div class="column">
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_input('text', 'phone', 'telefone', FALSE, $supplier[0]->phone); ?>
            <?php echo get_input('text', 'email', 'email', FALSE, $supplier[0]->email); ?>
            <?php echo get_input('text', 'url', 'site', FALSE, $supplier[0]->url); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_input('text', 'founded', 'fundação', FALSE, $supplier[0]->founded ? date('d/m/Y', $supplier[0]->founded) : FALSE); ?>
            <?php echo get_input('text', 'entitystatusdate', 'data do status da empresa', FALSE, $supplier[0]->entitystatusdate ? date('d/m/Y', $supplier[0]->entitystatusdate) : FALSE); ?>
            <?php echo get_input('text', 'entitystatus', 'status da empresa', FALSE, $supplier[0]->entitystatus); ?>
          </div>
          <div class="column-33 c-large c-medium c-small">
            <?php echo get_textarea('defaultaddress', 6, 'endereço padrão', $supplier[0]->defaultaddress, TRUE); ?>
          </div>
        </div>
        ...
        <div class="tab-wrapper">
          ...
          <div id="licensecontrol" class="tab-wrapper-content" style="display: none">
            ...
            <div class="column">
              <div class="column-33 c-large c-medium c-small">
                <?php echo get_input('text', 'federalpolicelicense', 'licença de polícia federal', FALSE, $supplier[0]->federalpolicelicense); ?>
                <?php echo get_input('text', 'datefederalpolicelicense', 'data expiração da licença da política federal', FALSE, $supplier[0]->datefederalpolicelicense ? date('d/m/Y', $supplier[0]->datefederalpolicelicense) : FALSE); ?>
              </div>
              <div class="column-33 c-large c-medium c-small">
                <?php echo get_input('text', 'civilpolicelicense', 'licença de polícia civil', FALSE, $supplier[0]->civilpolicelicense); ?>
                <?php echo get_input('text', 'datecivilpolicelicense', 'data expiração da licença da política civil', FALSE, $supplier[0]->datecivilpolicelicense ? date('d/m/Y', $supplier[0]->datecivilpolicelicense) : FALSE); ?>
              </div>
              <div class="column-33 c-large c-medium c-small">
                <?php echo get_input('text', 'armylicense', 'licença do exército', FALSE, $supplier[0]->armylicense); ?>
                <?php echo get_input('text', 'datearmylicense', 'data expiração da licença do exército', FALSE, $supplier[0]->datearmylicense ? date('d/m/Y', $supplier[0]->datearmylicense) : FALSE); ?>
              </div>
            </div>
            <div class="overflow">
              <div class="table">
          ...
          <div id="systeminformation" class="tab-wrapper-content" style="display: none">
            <div class="column">
              <div class="column-33 c-large c-medium c-small">
                <?php echo get_checkbox('isinactive', 'inativo', TRUE, $supplier[0]->isinactive); ?>
              </div>
              <div class="column-33 c-large c-medium c-small">
                <?php echo get_checkbox('iscustomer', 'cliente', FALSE, $supplier[0]->iscustomer); ?>
                <?php echo get_checkbox('issupplier', 'fornecedor', FALSE, $supplier[0]->issupplier); ?>
                <?php echo get_checkbox('iscarrier', 'transportadora', FALSE, $supplier[0]->iscarrier); ?>
              </div>
              <div class="column-33">
              </div>
            </div>
