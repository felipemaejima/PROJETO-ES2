<div class="container">
  <div class="box">
    <div class="box-title">
      Fornecedores
      <div>
        <a href="<?php echo base_url('supplier'); ?>">novo fornecedor</a>
      </div>
    </div>
    <div class="group-title search-tab"><i class="ph ph-minus-circle"></i> filtros</div>
    <div class="box-search search-suppliers">
            ...
            <?php foreach ($suppliers as $key => $supplier): ?>
              <div class="table-content <?php echo (($key + 1) % 2) == 0 ? 'table-content-color' : ''; ?>" style="min-width: 1400px; max-width: 100%;">
                <div class="column" style="min-width: 400px; padding-right: 1rem;;">
                  <i
                    class="ph-fill ph-circle <?php echo $supplier->confirmed == 'T' ? $supplier->isinactive == 'F' ? 'active' : 'invalid' : ''; ?>"></i>
                  <div>
                    <strong>
                    ...
                    <small>
                      <?php echo $supplier->document; ?>
                    </small>
                  </div>
                </div>
                <div class="column" style="min-width: 400px; padding-right: 1rem;">
                  <?php echo $supplier->legalname; ?>
                </div>
                <div class="column" style="min-width: 400px; padding-right: 1rem;">
                  <?php echo $supplier->phone; ?>
                </div>
                <div class="column" style="min-width: 200px; padding-right: 1rem;">
                  <a class="btn-blue" href="<?php echo base_url('supplier/' . $supplier->id); ?>">ver</a>
                  <a href="<?php echo base_url('supplier/' . $supplier->id . '?edit=T'); ?>">editar</a>
                </div>
              </div>
            <?php endforeach; ?>
          </div>
