...
|
*/
$config['encryption_key'] = 'c!YK*+XJnI$7_Zl#p8s-oGdQq#h*w&f^2aEv5yBzN@rM%mV(6t9LkSuAO1';
...
$config['sess_cookie_name'] = 'nat_session';
...
$config['csrf_token_name'] = 'CSRFerp';
$config['csrf_cookie_name'] = 'CSRFerp';
$config['csrf_expire'] = 7200;
$config['csrf_regenerate'] = FALSE;
$config['csrf_exclude_uris'] = array('tecnospeed-webhook');
